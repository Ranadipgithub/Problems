// problem statement: Given an array of long longegers, find the number of reverse pairs in the array. A reverse pair is defined as (i, j) such that i < j and arr[i] > 2 * arr[j].
